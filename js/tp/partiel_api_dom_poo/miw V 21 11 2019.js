...
(function(){  // ief  ou fie fonction immédiatement exécutée.
    ...
    extend(Array.prototype,{
        ...
        max :  function () {
            ...
            return (find)?max:find_caractere();
        },
        ...
        return (find)?min:find_caractere();
    },
        avg : function () {
        if (this.length == 0)
            return vide();
        ...
        return (find)?(somme/this.length).toFixed(2):find_caractere();
    }
    ...
    function find_caractere (){
        console.log('Le tableau contient une ou plusieurs valeurs non numériques');
    }
