...
class socialnetworklinks extends Module
{
    ...
    function install()
    {
        if (parent::install() == false OR
            ...
            Configuration::updateValue('snl_twitter', '1') == false OR
            Configuration::updateValue('snl_twitter_url', 'https://twitter.com/myprestaeu') == false OR
            Configuration::updateValue('snl_youtube', '1') == false OR
            Configuration::updateValue('snl_youtube_url', 'http://www.youtube.com/user/vekiapl') == false OR
            Configuration::updateValue('snl_google', '1') == false OR
            Configuration::updateValue('snl_google_url', 'https://plus.google.com/116184657854665082523/') == false OR
            Configuration::updateValue('snl_rss', '1') == false OR
            Configuration::updateValue('snl_rss_url', 'http://www.facebook.com/feeds/page.php?format=rss20&id=399888213399907') == false OR
            Configuration::updateValue('snl_instagram', '1') == false OR
            Configuration::updateValue('snl_instagram_url', 'http://instagram.com/mypresta') == false OR
            Configuration::updateValue('snl_vkontakte', '1') == false OR
            Configuration::updateValue('snl_vkontakte_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_odnru', '1') == false OR
            Configuration::updateValue('snl_odnru_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_nk', '1') == false OR
            Configuration::updateValue('snl_nk_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_flickr', '1') == false OR
            Configuration::updateValue('snl_flickr_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_linkedin', '1') == false OR
            Configuration::updateValue('snl_linkedin_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_pinterest', '1') == false OR
            Configuration::updateValue('snl_pinterest_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_myspace', '1') == false OR
            Configuration::updateValue('snl_myspace_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_lastfm', '1') == false OR
            Configuration::updateValue('snl_lastfm_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_yelp', '1') == false OR
            Configuration::updateValue('snl_yelp_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_picsart', '1') == false OR
            Configuration::updateValue('snl_picsart_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_tumblr', '1') == false OR
            Configuration::updateValue('snl_tumblr_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_digg', '1') == false OR
            Configuration::updateValue('snl_digg_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_wordpress', '1') == false OR
            Configuration::updateValue('snl_wordpress_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_deviantart', '1') == false OR
            Configuration::updateValue('snl_deviantart_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_weibo', '1') == false OR
            Configuration::updateValue('snl_weibo_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_qzone', '1') == false OR
            Configuration::updateValue('snl_qzone_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_formspring', '1') == false OR
            Configuration::updateValue('snl_formspring_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_blogger', '1') == false OR
            Configuration::updateValue('snl_blogger_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_ljournal', '1') == false OR
            Configuration::updateValue('snl_ljournal_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_ask', '1') == false OR
            Configuration::updateValue('snl_ask_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_orkut', '1') == false OR
            Configuration::updateValue('snl_orkut_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_googlep', '1') == false OR
            Configuration::updateValue('snl_googlep_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_apple', '1') == false OR
            Configuration::updateValue('snl_apple_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_adobe', '1') == false OR
            Configuration::updateValue('snl_adobe_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_vimeo', '1') == false OR
            Configuration::updateValue('snl_vimeo_url', 'http://mypresta.eu') == false OR
            Configuration::updateValue('snl_spotify', '1') == false OR
            Configuration::updateValue('snl_spotify_url', 'http://mypresta.eu') == false
    ...
    public function getvar()
    {
        ...
        $var->snl_spotify = Configuration::get('snl_spotify');
        $var->snl_spotify_url = Configuration::get('snl_spotify_url');
        return $var;
    }
    ...
    public function getContent()
    {
        ...
        if (isset($_POST['module_settings'])) {
            ...
            Configuration::updateValue('snl_spotify', Tools::getValue('snl_spotify'));
            Configuration::updateValue('snl_spotify_url', Tools::getValue('snl_spotify_url'));
        }
        ...
        <form id="updateslideform" action="' . $_SERVER['REQUEST_URI'] . '" method="post" enctype="multipart/form-data" >
			...
			<legend>' . $this->l('Social network links') . '</legend>
                            ...
                            <div style="display:block; clear:both; text-align:center; overflow:hidden;">
                                ...
                                <div style="display:block; clear:both;">
        							<label>' . $this->l('Spotify') . ':</label>
        							<div class="margin-form" style="text-align:left;">
                                    <input type="checkbox" name="snl_spotify" value="1" ' . (Configuration::get('snl_spotify') == 1 ? 'checked="yes"' : '') . '>
                                    <input type="text" name="snl_spotify_url" style="width:250px;" value="' . Configuration::get('snl_spotify_url') . '" />
        							</div>	
        		                </div>         		                                               
        	                </div>
